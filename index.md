...
myst:
  html_meta:
    description lang=en: >-
      PyMC is an open-source Python library for Bayesian modeling and
      probabilistic programming: build models in Python and fit them with
      MCMC (NUTS) or variational inference.
---
